...
<body>
  ...
  <section class="bg-white text-center">
    <h2>Classes to fit your needs</h2>
    <h3 class="sub">Choose in person or online classes with a dedicated instructor</h3>
    <div class="wrapper">
      <div class="box">
    ...
    <a href="rates.html" class="cta">see our pricing</a>
  </section>
